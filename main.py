...
if __name__ == "__main__":
    ...
    obstacle_coordinates = [(0, 3), (2, 1), (3, 7), (3, 4), (6, 3), (5, 0)] # Formerly tom_coordinates
    random_start = False

    env = create_env(goal_state=goal_coordinates,
                     blockers=obstacle_coordinates, # Still passing as 'blockers' to create_env which expects it
    ...
    train_q_learning(env,
                     ...
                     epsilon_min=0.015, #explore minimun rate
                     epsilon_decay=0.995,
                     alpha=0.1,
